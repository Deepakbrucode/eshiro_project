                    ...
                    <?php echo $this->session->flashdata('client_ledger'); ?>
                        <div class="col-md-12">
                            <table class="table table-striped table-hover table-bordered1 clientl_table" id="client_ledger" style="width:100%">
                                        ...
                                        ?>
                                            <tr data-id="<?php echo $client_id; ?>" data-cname="<?php echo $client_name; ?>" data-fname="<?php echo $file_number; ?>" data-fid="<?php echo $file_id; ?>" data-filename="<?php echo $file_name; ?>">
                                                <td><?php echo $k; ?></td>
           ...
           tr.removeClass('shown');
            ...
            tr.addClass('shown');
              ...
              $('.btn_clientmodal').on('click', function (event) {
                ...
                format(tr_id,tr_cname,tr_fname,tr_fid,tr_file_name);
...
function format ( client_id,client_name, file_number,fid,file_name ) {

var response_value = '';



show_ledgerdetails(client_id,client_name, file_number,fid,file_name);
...
*/
function show_ledgerdetails(client_id,client_name, file_number,fid,file_name){
 ...
 src = '<?php echo BASE_URL; ?>'+'reports/get_ClientLedger';
             ...
             $.ajax({
                ...
                dataType: "json",
                data: {
                    client_id : client_id, file_id: fid,client_name : client_name, file_number: file_number, file_name: file_name
                },
                success: function(data) {
                   ...
                   //response(data);
                    ...
                    var total_amount = 0;
                     response_value = '<p style="font-weight: bold;text-align: center;font-size:19px;margin: 0px;">'+client_name+'</p><p style="font-weight: bold;text-align: center;font-size:13px;    margin: 10px 0px;">'+file_name+'</p><p style="font-weight: bold;text-align: center;font-size:13px;    margin: 10px 0px 15px;">'+file_number+'</p><table style="width:100%;" class="table table-striped table-hover cldetails_table">';
                    if(typeof Other_details !== 'undefined' && Other_details !== null ){
                        //console.log("yrrrrrrrrrrrrrrrrrrrrr");
                         ...
                         if(typeof open_details !== 'undefined' && Other_details !== null)
                         {
                        ...
                        jQuery.each(Other_details,function(key,value){
                            ...
                            response_value += '<tr><td>'+val_date+'</td><td>'+trans_txt+'</td>';
                            response_value +='<td>'+file_number+'</td>';
                            var amount = parseFloat(amount);
                            //var format_amount = amount.toFixed(2);
                            var format_amount = amount.toLocaleString('en-IN', {minimumFractionDigits: 2});
