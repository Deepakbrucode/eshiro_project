                                    ...
                                    <div class="row">
                                        <div class="portlet light bordered">
                                            ...
                                            <?php echo $this->session->flashdata('payment'); ?>
                                                <!-- BEGIN FORM-->
                                                <form action="<?php echo BASE_URL;?>payments/<?php echo $form_action; ?>/" method="post" class="form-horizontal">
                                                    <input type="hidden" name="page_url" value="<?php echo $page_url; ?>" >
                                                    <input type="hidden" name="form_title" value="<?php echo $cusotm_field; ?>" >
                                                    <input type="hidden" name="payment_id" value="<?php echo $payment_id; ?>">
                                                    <input type="hidden" name="payment_olddate" value="<?php echo $payment_date; ?>">
                                                    ...
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" name="payment_date" class="form-control date-picker" placeholder="Date" value="<?php echo $payment_date; ?>" required>
                                                        ...
                                                        <!-- <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" name="client_name" id="client_name" class="form-control " placeholder="Client Name" value="<?php echo $client_name; ?>" required>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select id="select2_file" name="file_id" class="form-control select2" required>
                                                                    <option></option>
                                                                    <?php 
                                                                    if($FileDetails){
                                                                        foreach ($FileDetails as $FileDetail) {
                                                                           ...
                                                                           echo "<option value='".$FileDetail->file_id."' ".$selected.">".$file_name." / ".$FileDetail->file_number."</option>";
                                                                        }
                                                                    }
                                                                    ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" name="details" class="form-control" placeholder="Details" value="<?php echo $details; ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                            	 <select name="transaction_type" class="form-control" required>
                                                                    ...
                                                                    <option value="refund" <?php echo ($txn_type == 'refund' || $transaction_type1 == 'refund')?'selected':'' ?> >Refund</option>
                                                                    <option value="cost" <?php echo ($txn_type == 'cost' || $transaction_type1 == 'cost')?'selected':'' ?> >Cost</option>
                                                                    <option value="bank_charges" <?php echo ($txn_type == 'bank_charges' || $transaction_type1 == 'bank_charges')?'selected':'' ?> >Bank Charges</option>
                                                                    <option value="fee" <?php echo ($txn_type == 'fee' || $transaction_type1 == 'fee')?'selected':'' ?> >Fee</option>
                                                                </select> 
                                                            </div>
                                                        </div>
                                                        <!-- <div class="form-group">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body"> 
                            ...
                            <form action="<?php echo BASE_URL;?>file/addfile_submit" method="post" class="form-horizontal formadd_file">
                              ...
                              <input type="hidden" name="page_url" value="file">
 ...
 if(data == 'error')
                        {
                            //console.log("errr");
                            $(".error_msg").html('<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><span> File Name and File Number already exits</span></div>');
                        }
                        else
                        {
                  ...
                  if(data)
                  {
                    ...
                    $.each(data,function(key, value){
                       // console.log(value);
                        ...
                        option_html += "<option value='"+value['file_id']+"'>"+file_name+' / '+value['file_number']+"</option>";
                      }
                    })
                  }
