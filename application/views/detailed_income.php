    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>DETAILED INCOME STATEMENT</span>
                </li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
        <div class="row">
            ...
            <center><h3>DETAILED INCOME STATEMENT</h3></center>
            <input type="hidden" class="report_type" value="<?php echo $report_type; ?>">
            <a href="<?php echo BASE_URL; ?>/uploads/deailed_income.pdf" class="cash_pdfdownload" download style="display: none;">Download</a>  
            <a href="<?php echo BASE_URL; ?>uploads/deailed_income.xls" class="cash_xlsdownload" download style="display: none;">Download</a>
    ...
    ajax_bankstatyear()
            ...
            function ajax_bankstatyear(){
                ...
                var start_date = jQuery(".start_date").val();
                 ...
                 $.ajax({
                    url: '<?php echo BASE_URL; ?>'+'financialreport/ajax_detailed_income',
                    type:'POST',
                    //dataType: "json",
                    dataType: "html",
...
src = '<?php echo BASE_URL; ?>'+'financialreport/ajax_detailed_income_pdf';
