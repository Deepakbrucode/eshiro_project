                                ...
                                <table class="table table-striped table-hover table-bordered1 cashbook_table" id="cash_details" style="width:100%">
                                    ...
                                    <tbody>
                                       ...
                                       //echo "<pre>"; print_r($CashDetails);echo "</pre>";
                                        ...
                                        <tr>
                                            <td><?php echo $kk; ?></td>
                                            <td><?php echo $cash_month_name."-".$cash_year; ?></td>
                                            <td><button class='btn purple btn-outline sbold view_cashbook' data-month-name='<?php echo $cash_month_name; ?>' data-month='<?php echo $cash_month; ?>' data-year='<?php echo $cash_year; ?>'>View</button>   /
                                                     <a class="dt-button buttons-print btn dark btn-outline" data-toggle="confirmation" data-title="Receipt" data-singleton="true" data-popout="true" data-btn-ok-label="Delete" data-btn-ok-icon="fa fa-trash" data-btn-ok-class="btn-sm btn-danger" data-btn-cancel-label="Dismiss" data-btn-cancel-icon="fa fa-times" data-btn-cancel-class="btn-sm btn-default" data-original-title="" title="" aria-describedby="confirmation223268" href="<?php echo BASE_URL  ."OpeningBalance/delete_cashbook/" . $cash_month.'/'.$cash_year; ?>"><span class="color_orange">Delete</span></a>
                                            </td>
                                        </tr>
                                        <?php
                                          }
