                        ...
                        <div class="row">
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        Download Sample: 
                                        <!-- <a  href="<?php echo BASE_URL; ?>uploads/samples/sample_cashbook.csv" download><i class="fa fa-cloud-download"></i>  CSV</a> /  -->
                                        <a  href="<?php echo BASE_URL; ?>uploads/samples/bank-transactionimport.xls" download><i class="fa fa-cloud-download"></i>   Excel</a>

                                    </div>
                                </div>
                                <div class="portlet-body form">
                                    <br>
                                    <form action="<?php echo BASE_URL; ?>banktransactions/import_datamaping" method="post" enctype="multipart/form-data" name="form1" class="form-horizontal"> 
