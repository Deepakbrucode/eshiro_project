...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <!-- <button type="submit" name="" class="btn btn-warning btn_saveinvcost" style="width: 300px;margin: 14px;">Save</button> -->
...
jQuery(document).on('click','.btn_fcreport',function(){
    ...
    location.href = "<?php echo BASE_URL; ?>banktransactions/investigation_data/?client_id="+client_id;
});
