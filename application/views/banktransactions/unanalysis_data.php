        ...
        <div class="row">
            ...
            if ($usertype == '5') { ?>
                <div class="col-md-12">
                    ...
                    <div class="col-md-2"><a href="http://trustmanagers.co.za/report/banktransactions/analysis_data_month/?client_id=<?php echo $final_client_id; ?>" class="btn dark" style="float: right;"><i class="fa fa-hand-o-left"></i> Back</a></div>
                    <br>
                </div><br>
            <?php } ?>
                                                ...
                                                if ($amount_type == 'sales') {
                                                    if ($CostDetails) {
                                                        foreach ($CostDetails as $CostDetail) {
                                                            ...
                                                            // $selected = ($cost_id1 == 7448) ? 'selected' : '';
                                                    ...
                                                    if ($CostDetails) {
                                                        foreach ($CostDetails as $CostDetail) {
                                                            ...
                                                            $opt_val = $category_id1 . '-' . $subcategory_id1 . '-' . $cost_id1;
                                                            $selected = ($opt_sval == $opt_val) ? 'selected' : '';
                                                            // $selected = ($cost_id1 == 7480)?'selected':'';
                                                            echo "<option value='" . $opt_val . "' " . $selected . " >" . $CostDetail->cost_name . " (" . $links . ")</option>";
                                                        }
                                                    }
                                                }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        jQuery('#saveform').on('submit', function(e) {
            ...
            var src = '<?php echo BASE_URL; ?>' + 'banktransactions/saveinvcost';
        ...
        jQuery(document).on('click', '.btn_fcreport', function() {
            ...
            location.href = "<?php echo BASE_URL; ?>banktransactions/analysis_data/?client_id=" + client_id + "&month=" + month_val + "&year=" + year_val;
        });
