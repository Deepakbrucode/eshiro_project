                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn-sm btn green btn-outline1" href="<?php echo BASE_URL; ?>banktransactions/unanalysis_data/?client_id=<?php echo $final_client_id; ?>&month=<?php echo $month_val; ?>&year=<?php echo $year_val; ?>&bank_id=<?php echo $bank_id; ?>"><i class="fa fa-eye"></i> View </a>
