    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>Input Datas</span>
                </li>
            </ul>
        </div>
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12" style="text-align:right;"> <a href="<?php echo BASE_URL; ?>banktransactions/add_banktransactions?bank_id=<?php echo $bank_id; ?>" class="btn btn-primary">Add Transaction</a></div><br><br>
