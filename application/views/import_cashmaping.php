                                        ...
                                        <div class="portlet light bordered col-md-12">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-red-sunglo bold uppercase">Imported Cashbook Details</span>
                                                    <!-- <span class="caption-helper">details</span> -->
                                                </div>
                                            </div>
                                            <div class="portlet-body ">
                    <?php echo $this->session->flashdata('import_cashbook'); ?>
                      <form action="<?php echo BASE_URL;?>OpeningBalance/import_cashfilesave" class="import_cashfilesave"  method="post">
	<input type="hidden" name="opening_bal_from" value="<?php echo $opening_bal_from; ?>"/>
						<input type="hidden" name="opening_bal_to" value="<?php echo $opening_bal_to; ?>"/>
                 ...
                 $import_column ='
                    <td>
                         <select id="supplier" name="db_column[]" class="form-control" style="width:150px;">
                                    ...
                                    <option value="transacion_type">Transaction Type</option>
                  ...
                  <?php 
                  $j = 0;
                  foreach($cashbook_list as  $csvinfo){
                    $import_content .= '<tr>';  
