                                    ...
                                    <div class="row">
                                        <div class="portlet light bordered">
                                            ...
                                            foreach ($ReceiptDetail as $value) {
                                                ...
                                                $receipt_date = date('m/d/Y',strtotime($receipt_date));
                                                $bank = $value->bank;
                                                $amount = $value->amount;
                                            ...
                                            <?php echo $this->session->flashdata('receipts'); ?>
                                                ...
                                                <form action="<?php echo BASE_URL;?>receipts/<?php echo $form_action; ?>/" method="post" class="form-horizontal">
                                                    ...
                                                    <input type="hidden" name="receipt_olddate" value="<?php echo $receipt_date; ?>">
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" name="details" class="form-control" placeholder="Details" value="<?php echo $details; ?>" required>
                                                            </div>
                                                        </div>
