                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn-sm btn green btn-outline1" href="<?php echo BASE_URL; ?>reports/analysis_data/?client_id=<?php echo $final_client_id; ?>&month=<?php echo $month_val; ?>&year=<?php echo $year_val; ?>"><i class="fa fa-eye"></i> View </a>
...
jQuery(document).on('click','.btn_fcreport',function(){
    ...
    location.href = "<?php echo BASE_URL; ?>/reports/analysis_data_month/?client_id="+client_id;
});
