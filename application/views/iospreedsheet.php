        ...
        <div class="page-bar">
			<ul class="page-breadcrumb">
				<li>
                 ...
                 <li>
					<span>Input/Output SpreadSheet</span>
                 </li>
			</ul>
		</div>
		<!-- END PAGE HEADER-->
								...
								<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-red-sunglo bold uppercase">Input/Output SpreadSheet</span>
											<span class="caption-helper">Input/Output SpreadSheet</span>
										 </div>
                                    </div>
...
jQuery(document).on('click','.btn_casubmit',function(){
	...
	jQuery(".table_content").html('');
	 ...
	 var src = '<?php echo BASE_URL; ?>'+'reports/ajax_ousheet';
     $.ajax({
                    url: src,
                    type:'GET',
                    //dataType: "json",
