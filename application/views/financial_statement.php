        ...
        <div class="row">
            ...
            <form method="post" id="saveform">
                <div class="col-md-12">
                    ...
                    <a href="<?php echo BASE_URL; ?>/uploads/financial_report.pdf" class="cash_pdfdownload" download
                        style="display: none;">Download</a>
                    <!-- <a href="<?php echo BASE_URL; ?>uploads/cashbook_list.csv" class="cash_csvdownload" download style="display: none;">Download</a> -->
                    <a href="<?php echo BASE_URL; ?>uploads/financial_report.xls" class="cash_xlsdownload" download
                        style="display: none;">Download</a>
