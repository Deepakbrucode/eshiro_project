                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-red-sunglo bold uppercase">Import Trial Balance</span>
                                                ...
                                                <div class="actions">
                                                           Download Sample: <!--<a  href="<?php echo BASE_URL; ?>uploads/samples/sample_openingbalance.csv" download>
                                                            ...
                                                            <a  href="<?php echo BASE_URL; ?>uploads/samples/sample_trustledger.xls" download>
                                                ...
                                                <br>
                                                    <form action="<?php echo BASE_URL; ?>file/import_ledgermapping" method="post" enctype="multipart/form-data" name="form1" class="form-horizontal"> 
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input name="userfile" type="file" id="csv" required/>
                                                            </div>
                                                        </div>
