...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <center><h3>STATEMENT OF COMPREHENSIVE INCOME</h3></center>
            <input type="hidden" class="report_type" value="<?php echo $report_type; ?>">
            <a href="<?php echo BASE_URL; ?>/uploads/financial_report.pdf" class="cash_pdfdownload" download style="display: none;">Download</a>  
            <a href="<?php echo BASE_URL; ?>uploads/financial_report.xls" class="cash_xlsdownload" download style="display: none;">Download</a>
    ...
    ajax_bankstatyear()
            ...
            function ajax_bankstatyear(){
                ...
                var start_date = jQuery(".start_date").val();
                 ...
                 $.ajax({
                    url: '<?php echo BASE_URL; ?>'+'financialreport/ajax_comprehensive_income',
                    type:'POST',
                    //dataType: "json",
                    dataType: "html",
...
src = '<?php echo BASE_URL; ?>'+'reports/ajax_financial_statement_invoice_pdf';

}
else
{
    // src = '<?php echo BASE_URL; ?>'+'reports/financial_statement_pdf';
    src = '<?php echo BASE_URL; ?>'+'banktransactions/ajax_financial_statement_pdf_bankstat';
}
