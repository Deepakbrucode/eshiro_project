...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <input type="hidden" name="bank_id" class="bank_id" value="<?php echo $bank_id; ?>">
            <?php 
            if($usertype == '5') { ?>
            <div class="col-md-12">
            ...
            <form method="post" id="saveform">
                <div class="col-md-12">
                    ...
                    <a href="<?php echo BASE_URL; ?>/uploads/bankstat_list.pdf" class="cash_pdfdownload" download
                        style="display: none;">Download</a>
                    <!-- <a href="<?php echo BASE_URL; ?>uploads/cashbook_list.csv" class="cash_csvdownload" download style="display: none;">Download</a> -->
                    <a href="<?php echo BASE_URL; ?>uploads/bankstat_list.xls" class="cash_xlsdownload" download
                        style="display: none;">Download</a>
...
$(document).ready(function() {
    ...
    jQuery(document).on('click', '.btn_fcreport', function() {
        ...
        location.href = "<?php echo BASE_URL; ?>reports/bank_statement/?client_id=" + client_id;
    });
...
function ajax_bankstatyear(year) {
    ...
    // src = '<?php echo BASE_URL; ?>'+'reports/ajax_bankstat'; //arul 
    src = '<?php echo BASE_URL; ?>' + 'banktransactions/ajax_bankstat';
    $.ajax({
        url: src,
        type: 'GET',
        //dataType: "json",
...
$('.btn_bankstatpdf').on('click', function() {
    ...
    // src = '<?php echo BASE_URL; ?>'+'reports/bankstat_pdf'; //arul changed
    src = '<?php echo BASE_URL; ?>' + 'banktransactions/bankstat_pdf';
    $.ajax({
        url: src,
        type: 'GET',
        dataType: "json",
