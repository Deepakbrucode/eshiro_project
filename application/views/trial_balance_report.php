...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <center><h3><?php echo $ledger_title; ?> Details</h3></center>
            ...
            <div class="col-md-12">
                ...
                <a href="<?php echo BASE_URL; ?>/uploads/trialbalance_report.pdf" class="cash_pdfdownload" download style="display: none;">Download</a>
                    <!-- <a href="<?php echo BASE_URL; ?>uploads/cashbook_list.csv" class="cash_csvdownload" download style="display: none;">Download</a> -->
                    <a href="<?php echo BASE_URL; ?>uploads/trialbalance_report.xls" class="cash_xlsdownload" download style="display: none;">Download</a>
                 ...
                 <table class="table table-striped table-hover table-bordered1 stl_table" id="show_reporttb" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button type="button" class='btn purple btn-outline sbold view_bankstatyear' data-year='<?php echo $FiscalYear; ?>'>View</button> 
...
jQuery(document).on('click','.view_bankstatyear',function(){
    ...
    ajax_bankstatyear(data_year)
            ...
            function ajax_bankstatyear(year){
                ...
                if(report_type == 1)
                {
                    src = '<?php echo BASE_URL; ?>'+'reports/ajax_trial_balance_invoice';
                     //src = '<?php echo BASE_URL; ?>'+'banktransactions/ajax_financial_statement_invoice';
                }
                else
                {
                     src = '<?php echo BASE_URL; ?>'+'banktransactions/ajax_trialbalance_bankstat';
                 ...
                 $.ajax({
                    ...
                    //dataType: "json",
                    dataType: "html",
                    data: {'year':year,client_id:client_id,'report_type':report_type,'start_month':start_month,'end_month':end_month},
...
if(report_type == '1')
{
// src = '<?php echo BASE_URL; ?>'+'reports/financial_statement_pdf_invoice';
src = '<?php echo BASE_URL; ?>'+'reports/ajax_trialbalance_invoice_pdf';

}
else
{
    // src = '<?php echo BASE_URL; ?>'+'reports/financial_statement_pdf';
    src = '<?php echo BASE_URL; ?>'+'banktransactions/ajax_trialbalance_pdf_bankstat';
}
                 ...
                 $.ajax({
                    ...
                    type:'POST',
                    dataType: "json",
                    data: {'year':inputh_year,client_id:client_id,'report_type' :report_type},
                    success: function(data) {
