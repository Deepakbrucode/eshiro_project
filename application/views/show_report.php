...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12" style="text-align:right;"> <a href="<?php echo BASE_URL; ?>reports/add_report" class="btn btn-primary">Add Transaction</a></div><br><br>
...
jQuery(document).on('click','.btn_fcreport',function(){
    ...
    location.href = "<?php echo BASE_URL; ?>/reports/?client_id="+client_id;
})
