 ...
 $rbalance_total1 = money_format('%!i', $rbalance_total);
                                ...
                                ?>
                                    <!--<tr>
                                        ...
                                        <th style="text-align:left;">OPENING BALANCE <?php  echo $rformat_amount; ?></th>
                                        <th></th>
                                        <th></th>
                                        <th>R 5,71,231.03</th>
                                        <th>R 5,71,231.03</th>
        ...
        $psundry_total+= $pamount; }
                                       ...
                                       /*if($transaction_type == 'deposit'){$trans_txt = 'Deposit'; $psundry_amt=''; $pclient_amt = $pformat_amount;$pclient_total+=$pamount;}
                                         else if($transaction_type == 'rtd'){$trans_txt = 'RTD'; $psundry_amt='';$pclient_amt = $pformat_amount;$pclient_total+=$pamount; }
                                        else if($transaction_type == 'credit_interest'){$trans_txt = 'Credit Interest'; $psundry_amt= $pformat_amount;$pclient_amt = "";
                                        $psundry_total+= $pamount; }
                                        else {$trans_txt=''; $psundry_amt='';$pclient_amt = "R "+$pformat_amount;$pclient_total+= $pamount;}*/
                                    ...
                                    $pbalance_total1 = money_format('%!i', $pbalance_total);
                                     ...
                                     /* $psundry_total1 = number_format($psundry_total,2); 
   $pclient_total1 = number_format($pclient_total,2);
    $pbank_total1 = number_format($pbank_total,2); 
   $pbalance_total = ($pclient_total+$psundry_total) - $pbank_total;
 $pbalance_total1 = number_format($pbalance_total,2); */
