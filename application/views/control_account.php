								...
								<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-red-sunglo bold uppercase">Control Account</span>
											<span class="caption-helper">Control Account</span>
										 </div>
                                    </div>
...
jQuery(document).on('click','.btn_casubmit',function(){
	...
	jQuery(".table_content").html('');
	 ...
	 var src = '<?php echo BASE_URL; ?>'+'reports/ajax_ctrlaccount';
     $.ajax({
                    url: src,
                    type:'GET',
                    //dataType: "json",
